...
public class LoadDB {
    ...
    CommandLineRunner preLoadDB(RecipeRepository recipeRepository, UserRepository userRepository){
        return args -> {
            ...
            log.info("Preload Recipe 7: {}", recipeRepository.save(new Recipe(u3.getId(),"Lemon Herb Roasted Chicken and Veggies", MealType.DINNER,"1 whole chicken (about 3-4 lbs), " +
                    "1 lb baby potatoes (halved), 1 lb carrots (chopped), 1 large onion (quartered), 2 lemons (1 sliced, 1 juiced), 4 cloves garlic (minced), 2 tbsp olive oil, 1 tbsp dried Italian herbs," +
                    " 1 tsp salt, 1/2 tsp black pepper, Fresh rosemary sprigs (optional), Fresh thyme sprigs (optional)"
                    ,"Preheat oven to 400°F (200°C), In a large bowl, toss potatoes, carrots, and onion with 1 tbsp olive oil, salt, pepper, and Italian herbs, Place the vegetables in a single " +
                    "layer in a large roasting pan, Rinse the chicken and pat it dry with paper towels, In a small bowl, combine lemon juice, minced garlic, remaining 1 tbsp olive oil, salt, and pepper, " +
                    "Rub the mixture all over the chicken, including under the skin of the breast, Stuff the chicken cavity with lemon slices, rosemary, and thyme (if using), Place the chicken on top of the " +
